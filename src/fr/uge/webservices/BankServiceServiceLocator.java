...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements fr.uge.webservices.BankServiceService {
    ...
    public fr.uge.webservices.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.webservices.BankServiceSoapBindingStub _stub = new fr.uge.webservices.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.webservices.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.webservices.BankServiceSoapBindingStub _stub = new fr.uge.webservices.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.uge.fr", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.uge.fr", "BankService"));
        }
